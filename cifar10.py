...
# python resnet8.py --data /home/fwu/code/pytorch/pytorch-mini/datasets/ --mode emb
...
test_set = torchvision.datasets.CIFAR10(root=args.data, train=False, download=True, transform=transforms_test)
...
if args.resume:
    ...
    checkpoint = torch.load("./checkpoint/cifar10_resnet8_" + args.mode + ".pt")
    net = checkpoint["net"]
